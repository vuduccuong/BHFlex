...
{
    public partial class fmScanner1D : Form
    {
        public fmScanner1D()
        {
            InitializeComponent();
        ...
        {                                                                      //chu y: NameDeviceType =?
            ...
            var query = String.Format("insert into DeviceInfos(IdDevice,nameTypeDeviceInfos,NameDevice,IPAdress,Model,BuyDate,Note,idDeviceType,IdPartment,isDelete) values('" + txtBarcodeScannerName.Text + "','" + txtBarcodeScannerName.Text + "','Barcode Scanner 1D','" + txtIPBarcodeScanner.Text + "', '" + txtModel.Text + "', '" + txtBuydate.Text + "','" + rtbNote.Text + "', '" + getIdDevices.ToString() + "', '" + idPartment.ToString() + "',0)");
