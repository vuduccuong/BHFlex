...
namespace IT_Management.UI.FormTypeDevices
{
    public partial class fmBarScannerWifi2D : Form
    {
        ...
        private void fmBarScannerWifi2D_Load(object sender, EventArgs e)
        {
            txtid.Enabled = false;
